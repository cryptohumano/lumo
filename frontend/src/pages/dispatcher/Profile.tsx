...
import { UserCircle, Save, ArrowLeft, Mail, Phone, MapPin, Radio, Wallet, CheckCircle2 } from 'lucide-react'
    ...
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      ...
      <div className="mb-8">
        ...
        <p className="text-muted-foreground">
          {t('profile.dispatcher.description') || 'Gestiona tu perfil de despachador'}
        </p>
      </div>
            ...
            <CardContent className="space-y-6">
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <Badge variant="secondary" className="mt-1">
                    {t('roles.dispatcher') || 'Despachador'}
                  </Badge>
                </div>
              </div>
              ...
              <div>
                ...
                <Textarea
                  ...
                  placeholder={t('profile.bioPlaceholder') || 'Información sobre tu rol como despachador...'}
                  rows={4}
                />
              </div>
            </CardContent>
