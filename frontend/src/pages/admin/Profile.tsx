...
import { UserCircle, Save, ArrowLeft, Mail, Phone, MapPin, Shield, Wallet, CheckCircle2 } from 'lucide-react'
    ...
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      ...
      <div className="mb-8">
        ...
        <p className="text-muted-foreground">
          {t('profile.admin.description') || 'Gestiona tu perfil de administrador'}
        </p>
      </div>
            ...
            <CardContent className="space-y-6">
                  ...
                  <div className="flex items-center gap-2 mt-1">
                    ...
                    {user.isRootAdmin && (
                      <Badge variant="destructive">
                        {t('profile.rootAdmin') || 'Root Admin'}
                      </Badge>
                    )}
                  </div>
                </div>
              ...
              <div>
                ...
                <Textarea
                  ...
                  placeholder={t('profile.bioPlaceholder') || 'Información sobre tu rol como administrador...'}
                  rows={4}
                />
              </div>
            </CardContent>
